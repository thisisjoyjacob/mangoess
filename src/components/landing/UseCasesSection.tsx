...
export const UseCasesSection = ({ show }: UseCasesSectionProps) => {
      ...
      <div className="mt-24 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3 mb-8">
          {useCases.map((useCase, idx) => (
            <div
              ...
              className={cn(
                "glass-panel rounded-xl p-4 flex flex-col items-center text-center cursor-pointer transition-all duration-300 hover:shadow-md",
                activeCase === idx ? "ring-2 ring-primary shadow-md" : ""
              )}
            >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-6">
                {useCases[activeCase].connections.map((connection, idx) => (
                  <span 
                    key={idx} 
                    className={`px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r ${useCases[activeCase].color} bg-opacity-10 text-primary`}
                  >
                    {connection}
                  </span>
                ))}
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="overflow-hidden">
            <div className={`h-1.5 w-full bg-gradient-to-r ${useCases[activeCase].color}`}></div>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2 mb-2">
                <svg className="text-amber-500" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="none">
              ...
              <CardDescription className="text-sm italic">
                "Cortex has transformed my research process completely. I can now see connections between papers I never would have noticed before."
              </CardDescription>
              <div className="mt-4 text-sm font-medium">Dr. Sarah Chen</div>
              <div className="text-xs text-muted-foreground">Neuroscience Researcher</div>
            </CardContent>
          </Card>
          ...
          <Card className="overflow-hidden">
            ...
            <CardContent className="pt-6">
              ...
              <CardDescription className="text-sm italic">
                "As a developer, having all my code snippets, documentation and architecture notes linked together has been a game changer."
              </CardDescription>
              <div className="mt-4 text-sm font-medium">Alex Johnson</div>
          ...
          <Card className="overflow-hidden">
            ...
            <CardContent className="pt-6">
              ...
              <CardDescription className="text-sm italic">
                "I wrote my entire dissertation using Cortex. Being able to visualize connections between different literary theories was invaluable."
              </CardDescription>
              <div className="mt-4 text-sm font-medium">Maria Rodriguez</div>
              <div className="text-xs text-muted-foreground">PhD Candidate, Literature</div>
            </CardContent>
          </Card>
        </div>
      </div>
